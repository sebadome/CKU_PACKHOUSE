...
const ANALISIS_PRECOSECHA_TEMPLATE: FormTemplate = {
  ...
  publishedTo: ['TrabajadorCKU', 'Administrador'],
  icon: 'file-text',
  sections: [
    {
      key: 'datos_generales',
      ...
      fields: [
        ...
        { key: 'promedio_peso', label: 'PROMEDIO X Peso (g)', type: 'decimal', readOnly: true, help: 'Cálculo automático.' },
        {
            ...
            dependency: {
              ...
              value: ['ROJAS', 'GALA', 'CRIPPS PINK', 'AMBROSIA', 'FUJI', 'KANZI','IFO RED','MC']
            }
        },
        { 
    ...
    },
    {
        ...
        fields: [
            ...
            },
            {
                ...
                dependency: {
                  key: 'recepcion.variedad_rotulada_grupo',
                  value: ['ROJAS', 'GALA', 'CRIPPS PINK', 'AMBROSIA', 'FUJI', 'KANZI','GRANNYS','IFO RED','MC']
                }
            }
        ]
    },
        ...
        fields: [
            {
                ...
                user_can_add_rows: true,
                user_can_add_columns: false,
                hideBrix: true, // Hides Brix column
                hideCalibre: true, // NEW: Hides Calibre column
                showSummaryColumns: true, 
                showOnlyAverage: true, // NEW: Hides MAX/MIN and renames X header
                initialRows: [
                    {
                        _id: uuidv4(),
                        n_frutos: '',
            ...
            fields: [
                {
                    ...
                    columns: [
                        ...
                        { 
                            ...
                            label: 'VARIEDAD ROT.', 
                            type: 'select', 
                            options: ['ROJAS', 'GALA', 'CRIPPS PINK', 'AMBROSIA', 'FUJI', 'KANZI', 'GRANNYS','IFO RED','MC'],
                            required: false 
                        },
                        { 
                            key: 'tipo_frio', 
